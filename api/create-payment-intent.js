...
export default async function handler(req, res) {
  ...
  try {
    ...
    const PRICES = {
      starter:     { amount: 10000, name: 'Starter Site',       type: 'one_time'  }, // $100
      landing:     { amount: 20000, name: 'Landing Page',        type: 'one_time'  }, // $200
      business:    { amount: 30000, name: 'Business Site',       type: 'one_time'  }, // $300
      premium:     { amount: 40000, name: 'Premium Business',    type: 'one_time'  }, // $400
      ecommerce:   { amount: 50000, name: 'E-Commerce Site',     type: 'one_time'  }, // $500
      maintenance: { amount: 1500,  name: 'Monthly Maintenance', type: 'recurring' }, // $15/mo
      logo:        { amount: 5000,  name: 'Logo Design',         type: 'one_time'  }, // $50
    };
    ...
    if (oneTimeItems.length > 0) {
      ...
      const paymentIntent = await stripe.paymentIntents.create({
        ...
        receipt_email: email,
        description,
        metadata: { items: oneTimeItems.join(','), customer_name: name },
